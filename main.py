...
from handlers.ttt_online import tictactoe_online
from handlers.start_handlers import start, get_age
    ...
    conv_handler = ConversationHandler(
        ...
        states={
            MAINMENU: [
                ...
                CallbackQueryHandler(tictactoe_bot_start, pattern="bot_tictactoe"),
            ],
             GET_AGE: [
            ...
            TICTACTOE: [CallbackQueryHandler(tictactoe, pattern="^[0-8]$")],
            TICTACTOE_ONLINE: [
